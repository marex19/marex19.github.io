...
#fi
  ...
  #echo "$title"
  #echo $font
  #convert -resize 50% "$image" /var/www/pics/tmp_background.jpg
  convert -resize 50% -font $font -fill black -pointsize 20 -annotate +50+100 "$title" "$image" /var/www/pics/background.jpg
fi
